...
public class homePage extends basePage {
    ...
    public @FindBy(xpath = "//a[@class='dropdown-toggle']") WebElement circleIcon;

    public @FindBy(linkText = "Log Out") WebElement logOutLink;
...
//div[contains(text(),"Appointment 'Consultation' is due soon")]
    ...
    @FindBy(xpath = "(//a[@class='nav-link nav-toggle'])[2]") WebElement appointmentsLink;
    @FindBy(xpath = "(//a[@class='nav-link '])[4]") public WebElement bookAppointmentLink;
