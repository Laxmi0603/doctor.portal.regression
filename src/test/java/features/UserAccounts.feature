...
Feature: Verifying the Admin login credentials and log out features
  ...
  Scenario Outline: Admin can not Login with In Valid credentials
  ...
  Scenario Outline: Admin can login and Log Out successfully with valid credentials
  ...
  Scenario Outline: Admin can Login with Valid credentials
